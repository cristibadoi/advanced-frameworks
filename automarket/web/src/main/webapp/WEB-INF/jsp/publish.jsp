  ...
  <div class="container">
    ...
    <form name="publish-form" action="/publish" method="post" enctype="multipart/form-data">
      <div class="form-group">
        <label for="brand"><spring:message code="label.publish-brand" /></label> <select data-live-search="true"
      ...
      <div class="form-group">
        <label for="model"><spring:message code="label.publish-model" /></label> <select data-live-search="true"
          class="selectpicker form-control" id="model" name="model"
          title="<spring:message code="label.publish-choose" />" required>
        </select>
      </div>
      <div class="form-group">
        <label for="type"><spring:message code="label.publish-type" /></label> <select data-live-search="true"
          class="selectpicker form-control" id="type" name="type" title="<spring:message code="label.publish-choose" />"
          required>
      ...
      <div class="form-group">
        <label for="fuel"><spring:message code="label.publish-fuel" /></label> <select data-live-search="true"
          class="selectpicker form-control" id="fuel" name="fuel" title="<spring:message code="label.publish-choose" />"
          required>
      ...
      <div class="form-group">
        <label><spring:message code="label.publish-year" /></label> <select data-live-search="true"
          class="selectpicker form-control" id="year" name="year" data-size="10"
          title="<spring:message code="label.publish-choose" />" required>
      ...
      <div class="form-group">
        <label for="images"><spring:message code="label.publish-images" /></label> <input type="file"
          accept=".jpg, .png" class="form-control" id="images" name="images" multiple required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="city"><spring:message code="label.publish-city" /></label> <select data-live-search="true"
          class="selectpicker form-control" id="city" name="city" title="<spring:message code="label.publish-choose" />"
          required>
      ...
      <div class="form-group">
        <label for="email"><spring:message code="label.publish-email" /></label> <input type="email"
