        ...
        <article class="search-result row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-7">
            ...
            <ul class="list-inline">
              ...
              <li>
                <ul class="list-unstyled">
                  <li><a href="/account/articles/delete/${element.id}?action=delete"
                    onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-primary">
                        <spring:message code="label.account-delete-button" />
                      </button></a></li>
                  <li><a href="/account/articles/delete/${element.id}?action=sold"
                    onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-success">
