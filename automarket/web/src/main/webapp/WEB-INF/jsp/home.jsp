...
<head>
  ...
  <link rel="stylesheet"
        href=
        <c:url value="/webjars/bootstrap/3.3.7-1/css/bootstrap.min.css"/>/>
  <script
      src=<c:url value="/webjars/bootstrap-select/1.12.0/js/bootstrap-select.min.js"/>></script>
  <link rel="stylesheet"
        href=
        <c:url value="/webjars/bootstrap-select/1.12.0/css/bootstrap-select.min.css"/>/>
    ...
    <ul class="nav navbar-nav">
      <sec:authorize access="isAnonymous()">
        <li><a href="<c:url value="/login" />"><spring:message
            code="label.menu-login-button"/></a></li>
        <li><a href="<c:url value="/register" />"><spring:message
            code="label.menu-register-button"/></a></li>
      </sec:authorize>
      <li><a href="<c:url value="/publish" />"><spring:message
          code="label.menu-publish-button"/></a></li>
  ...
  <form name="search-form" action="/search" method="get">
    <div class="form-group">
      ...
      <select data-live-search="true" class="selectpicker form-control"
        ...
        <option value='' selected><spring:message
            code="label.default-selection"/></option>
    ...
    <div class="form-group">
      ...
      <div class="form-inline">
        <input name="minCapacity" type="number" class="form-control"
               id="minCapacity"
               placeholder="<spring:message code="label.min-capacity" />">
        <input name="maxCapacity" type="number" class="form-control"
               id="maxCapacity"
               placeholder="<spring:message code="label.max-capacity" />">
      </div>
    </div>
    <div class="form-group">
      <label><spring:message code="label.select-year"/></label>
      <div class="form-inline">
        <input name="minYear" type="number" class="form-control"
               id="minYear"
               placeholder="<spring:message code="label.min-year" />"> <input
          name="maxYear" type="number" class="form-control" id="maxYear"
          placeholder="<spring:message code="label.max-year" />">
      </div>
    </div>
    <div class="form-group">
      <label><spring:message code="label.select-mileage"/></label>
      <div class="form-inline">
        <input name="minMileage" type="number" class="form-control"
               id="minMileage"
               placeholder="<spring:message code="label.min-mileage" />">
        <input name="maxMileage" type="number" class="form-control"
               id="maxMileage"
               placeholder="<spring:message code="label.max-mileage" />">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="form-inline">
        <input name="minPrice" type="number" class="form-control"
               id="minPrice"
               placeholder="<spring:message code="label.min-price" />"> <input
          name="maxPrice" type="number" class="form-control" id="maxPrice"
          placeholder="<spring:message code="label.max-price" />">
      </div>
    </div>
    <div class="form-group">
